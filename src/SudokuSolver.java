...
public class SudokuSolver {    
    ...
    private boolean[][] ColsVal;
    private boolean[][] RowsVal;
    ...
    public SudokuSolver() {
        ...
        this.ColsVal = new boolean[9][10];
        this.RowsVal = new boolean[9][10];
    }
    ...
    public void placeVal(int val, int row, int col) {
        ...
        this.RowsVal[row][val] = true;
        this.ColsVal[col][val] = true;
    }
    ...
    public void removeVal(int val, int row, int col) {
        ...
        /*** UPDATE YOUR ADDITIONAL FIELDS HERE. ***/
        this.ColsVal[col][val] = false;
        this.RowsVal[row][val] = false;
    }  
    ...
    /*** IsPlace: to check whether a cell already has a number ***/
    private boolean IsPlace(int val, int col, int row){
        boolean result = true;
        if(this.ColsVal[col][val] || this.RowsVal[row][val] || this.subgridHasVal[row/3][col/3][val]){
            result = false;
        }
        return result;
    }
